...
const postFooterIcons = [
  ...
  },
  {
    name: "Comment",
    imageUrl:
      "https://img.icons8.com/material-outlined/24/ffffff/speech-bubble.png",
  },
  {
    name: "Share",
    imageUrl:
  ...
  },
  {
    name: "Save",
    imageUrl:
      "https://img.icons8.com/fluency-systems-regular/24/ffffff/bookmark-ribbon--v1.png",
  },
];
...
const PostHeader = ({ post }) => (
  ...
  >
    <View style={{ flexDirection: "row", alignItems: "center", margin: 5 }}>
      ...
      <Text style={{ color: "white", margin: 5, fontWeight: "700" }}>
        {post.user}
      </Text>
    </View>
